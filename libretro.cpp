...
bool retro_load_game(const struct retro_game_info *info)
{
   struct retro_input_descriptor desc[] = {
      ...
      { 0, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_C, "III" },
      ...
      { 1, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_C, "III" },
      ...
      { 2, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_C, "III" },
      ...
      { 3, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_C, "III" },
      ...
      { 4, RETRO_DEVICE_JOYPAD, 0, RETRO_DEVICE_ID_JOYPAD_C, "III" },
   ...
   for (unsigned port = 0; port < max_port; port++)
   {
      ...
      case RETRO_DEVICE_JOYPAD:
      {
         ...
         else
         {
            ...
            for (unsigned id = 0; id < RETRO_DEVICE_ID_JOYPAD_BUTTON_MAX; id++)
         ...
         if (ret & BIT(RETRO_DEVICE_ID_JOYPAD_C))
            input_state |= JOY_III;
         if (ret & BIT(RETRO_DEVICE_ID_JOYPAD_Z))
            input_state |= JOY_IV;
